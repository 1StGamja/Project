...
cur.execute("SELECT DISTINCT author_screen_name FROM public.twt_jg_20230411;")
users = cur.fetchall()
...
for user in users:
    try:
        ...
        dm_history = api.list_direct_messages(20)
        conversation_exists = False

        for dm in dm_history:
            if dm.message_create['sender_id'] == recipient_id or dm.message_create['target']['recipient_id'] == recipient_id:
